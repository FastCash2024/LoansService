...
const verificationCollectionBackupSchema = new mongoose.Schema({
    ...
    registroDeNotas: String,
    nombreDelProducto: String,
    fechaDeReembolso: String, // Cuando el cliente pagó la deuda 
    fechaDeCreacionDeLaTarea: String, // cuando el caso se manda a solicitud
    fechaDeTramitacionDelCaso: String, // fecha de asignación del caso
    nombreDeLaEmpresa: String,
    cantidadDispersada: String,
    fechaDeDispersion: String,
  ...
  export const VerificationCollectionBackup = mongoose.model('VerificationCollectionBackup', verificationCollectionBackupSchema);
